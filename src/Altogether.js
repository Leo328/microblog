...
class Jumobotron extends Component {
    render(){
        return (
        ...
        return (
            <div className="row">
                <form onSubmit={this.submitForm}>
                    ...
                    <br/>
                    <textarea className="form-control" id="exampleTextarea" rows="10" value={this.state.body} onChange={this.onBodyChange}></textarea>
                    </div>
